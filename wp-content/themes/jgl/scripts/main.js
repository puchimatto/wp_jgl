    ...
    common: {
        init: function() {
            ...
            if(sections.length <= 1){
                ...
                stkntmin = $(sections[1]).position().top;
            }
            $('body').scrollspy({
                min:        stkntmin,
                max:        $('body').height(),
                ...
                onLeave:    function(e,p) {
                    $('#sticky-note-addr').fadeOut(function(){
        ...
        init: function() {
            ...
            (function($){
                ...
                slideSwitch = function(dest) {
                    ...
                    var videoVisible = $("#youtubevideo").hasClass("active");
                    if (videoVisible) {                
                        $(".carousel-text").css("display","none");
                    }else{ $(".carousel-text").css("display","block");};
                }
                ...
                YTPlayer = function(){
                    var videoIdentificador = $('#yt-image').data('yt');
