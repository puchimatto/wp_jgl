                        ...
                        <form method="post" id="comment-form-contact" data-sum="<?php printf("¿Cuánto es %s + %s?", $n1, $n2); ?>">
                            ...
                            <ul>
                                ...
                                <li style="z-index:999;">
                                    <label for="asesor">Le interesa en particular un servicio de:</label>
                                    <?php
                                        $value = "";
                                        if(isset($_GET["id"])){
                                            $p = get_post($_GET["id"]);
                                    ...
                                    ?>
                                    <input type="text" placeholder="Elija el servicio que le interese" value="<?php echo $value; ?>" name="plan" id="plan" disabled>
                                    <div id="key">
                                    </div>
                                    <div id="plan-options">
