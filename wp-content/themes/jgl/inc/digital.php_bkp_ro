            ...
            <section class="section2" id="semblanza-find">
                ...
                <div class="semblanzas">
                    <div id="find-semblanza">
                        ...
                        <input type="text" id="dateField" placeholder="Escribe aquí el nombre que deseas encontrar" >
                        <input type="hidden" id="autocomplete_selected" />                             
                        <form id="semblanza-finder">
                            <a class="semblanza-button" type="submit"></a>                            

                            <input type="text" placeholder="Escribe aquí el nombre que deseas encontrar" id="search-semblanza" style="display:none;">
                        </form>
