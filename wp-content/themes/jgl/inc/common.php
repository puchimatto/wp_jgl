...
<?php
    ...
    function black_footer(){
        ?>
                    <div class="footer">
                        <p>J. García López Casas Funerarias. Todos los derechos reservados.</p>
                        <p>La vida merece un homenaje®. <a href="<?php hurl(); ?>politica-de-privacidad">Ver política de privacidad</a></p>
