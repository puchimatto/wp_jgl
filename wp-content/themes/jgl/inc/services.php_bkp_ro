...
<div class="content">
            <div class="container">
                ...
                <section class="section-2 enterprise" id="services-enterprise">
                    ...
                    <div class="pages">
                        ...
                        <article class="main plan-total-40">
                            <div class="frame" style="padding:20px;">
                                ...
                                <p class="more">
                                    <a class="button" href="<?php hurl(); ?>contacto/?id=<?php echo $myplans[0]->ID; ?>">Solicita información</a>
                                </p>
                            </div>
                        </article>
                        <article class="left plan-total-20">
                            <div class="frame">
                                ...
                                <p class="more">
                                    <a class="button" href="<?php hurl(); ?>contacto/?id=<?php echo $myplans[1]->ID; ?>">Solicita información</a>
                                </p>
                            </div>
                        </article>
                        <article class="right plan-total-60">
                            <div class="frame">
                                ...
                                <p class="more">
                                    <a class="button" href="<?php hurl(); ?>contacto/?id=<?php echo $myplans[2]->ID; ?>">Solicita información</a>
                                </p>
                            </div>
                        </article>
                    </div>
                    <div class="newsletter">
                        ...
                        <form id="newsletter" data-sum="<?php printf("¿Cuánto es %s + %s?", $n1, $n2); ?>">
                            ...
                            <input type="text" placeholder="Tu nombre" required name="name" id="name-news">
                            <input type="mail" placeholder="Tu e-mail" required name="email" id="email-news">
                ...
                <section class="section-8 additional" id="services-additional" style="height:788px;">
                    ...
                    <div class="choose">
                        <h3>Selecciona el servicio que te interesa</h3>
                        <?php
                        ...
                        <div class="details">
                            ...
                            <div class="item">
                                ...
                                <h4><?php the_title(); ?></h4>
                                <?php the_content(); ?>
                                <p class="more"><a href="<?php hurl(); ?>contacto/?id=<?php the_ID(); ?>" class="button">Solicita información</a><!-- All these buttons should indicate that the user comes from this section --></p>
                            </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
