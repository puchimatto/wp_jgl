...
//		echo "CADENA ".$cadena;	
	?>
	<script type="text/javascript">startIeFix();</script><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="280" height="343">
                  <param name="movie" value="obituariointerior.swf<?=$cadena?>&" />
                  <param name="quality" value="high" />
                  <embed src="obituariointerior.swf<?=$cadena?>&" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="280" height="343"></embed>
