...
<div id="red_comercial">
	<ul id="horizontal">
		...
		<li>
			<img src="<?php bloginfo('template_url'); ?>/images/CI.jpg">
		</li>
		<li>
			<img src="<?php bloginfo('template_url'); ?>/images/First-American.jpg">
		</li>
		<li>
		<img src="<?php bloginfo('template_url'); ?>/images/silla-de-ruedas.jpg">
		</li>
	</ul>
</div>
