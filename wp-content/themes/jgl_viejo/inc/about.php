                ...
                <section class="section-5 campaigns" id="about-campaigns">
                    ...
                    <div class="categories">
                        <div class="category photo">
                            <h3><i class="icon-chevron-down bullet change"></i> Exteriores</h3>
                            <div class="details">
                                <div class="carousel">
                                    <ul class="gallery">
...
<?php
    ...
    function campings_li_exteriores(){
        ...
        $id_type = 30;
        $array_category = array($id_type);
        $args = array('category__and' => $array_category, 'numberposts' => 20, 'order' => 'ASC');
        $myposts = get_posts( $args );
        $c = 0;
    ...
    function campings_li_videos(){
        ...
        $id_type = 32;
        $array_category = array($id_type);
        $args = array('category__and' => $array_category, 'numberposts' => 16, 'order' => 'ASC');
        $myposts = get_posts( $args );
        foreach ($myposts as $post):
            ?>
                                        <li class="item">
