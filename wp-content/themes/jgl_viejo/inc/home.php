...
?>
                <section class="section-1 intro" id="home-intro" style="padding:0;">
                    ...
                    <div class="end">
                        <a href="#home-intro"><i class="icon-chevron-up"></i></a>
                    </div>
                </section>
<?php
    }
...
?>
                <section class="section-2 about" id="home-about">
                   ...
                   <!-- DESACTIVADO -->
                    ...
                    <div class="end">
                        <a href="#home-about"><i class="icon-chevron-up"></i></a>
                    </div>
...
?>
                <section class="section-4 plans" id="home-plans">
                    ...
                    <div class="end">
                        <a href="#home-plans"><i class="icon-chevron-up"></i></a>
                    </div>
                </section>
<?php
    }
...
?>
                <section class="section-5 locations" id="home-locations">
                    ...
                    <div id="hide-locations">
                        ...
                        <div class="end">
                            <a href="#home-locations"><i class="icon-chevron-up"></i></a>
                        </div>
                    </div>
                </section>
<?php
